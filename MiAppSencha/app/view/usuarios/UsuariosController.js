Ext.define('MiAppSencha.view.usuarios.UsuariosController',{
    extend: 'Ext.app.ViewController',
    alias: 'controller.usuarios',

    mostrarFormulario: function(){
        var window = Ext.create('MiAppSencha.view.usuarios.VentanaUsuario');
        window.show();
    },
    ...
    onEditar: function(grid, rowIndex){
        ...
        var formulario = Ext.create('MiAppSencha.view.usuarios.VentanaUsuario',{
            store: usuario
        })
    ...
    onEliminar: function(grid, rowIndex){
        var usuario = grid.getStore().getAt(rowIndex).data
        Ext.Msg.confirm("Eliminar usuario","¿Seguro que desea eliminar este usuario?",function(respuesta){
            if(respuesta == "yes"){
                Ext.Ajax.request({
